...
public class ST 
{
	...
	public final static String URN_PRI = "urn:projector-iview-com:device:";
	...
	public final static boolean isURNPri(String value)
	{
		if (value == null)
			return false;
		if (value.startsWith(URN_PRI) == true)
			return true;
		return value.startsWith("\"" + URN_PRI);
	}
}
