...
public class HostInterface
{
	...
	private final static String TAG = "HostInterface";
		...
		try {
			...
			while (nis.hasMoreElements()){
				...
				while (addrs.hasMoreElements()) {
					...
					Log.e(TAG, "getNHostAddresses addr :" + addr.toString());
	...
	public final static String getHostAddressByType(String type) {
		String hostIp = null;
		try {
			Enumeration nis = NetworkInterface.getNetworkInterfaces();
			InetAddress ia = null;
